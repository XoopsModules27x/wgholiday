...
function loadSampleData(): void
{
    ...
    \redirect_header('../admin/index.php', 1, \constant('_CO_WGHOLIDAY_SAMPLEDATA_SUCCESS'));
}
...
function saveSampleData(): void
{
    ...
    \redirect_header('../admin/index.php', 1, \constant('_CO_WGHOLIDAY_SAVE_SAMPLEDATA_SUCCESS'));
}
...
function exportSchema(): void
{
    ...
    try {
        ...
        //        $migrate = new Wgholiday\Migrate($moduleDirName);
        //        $migrate->saveCurrentSchema();
        //
        //        \redirect_header('../admin/index.php', 1, \constant('_CO_WGHOLIDAY_EXPORT_SCHEMA_SUCCESS'));
    } catch (\Exception $e) {
        exit(\constant('_CO_WGHOLIDAY_EXPORT_SCHEMA_ERROR'));
    }
}
