...
$modPathIcon16   = \WGHOLIDAY_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = \WGHOLIDAY_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
// Load languages
\xoops_loadLanguage('admin', 'wgholiday');
\xoops_loadLanguage('modinfo', 'wgholiday');
// \xoops_loadLanguage('main', 'wgholiday');
...
$style = \WGHOLIDAY_URL . '/assets/css/admin/style.css';
